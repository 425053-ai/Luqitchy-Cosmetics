...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Lip Gloss shades are 99 EGP (instead of 150 EGP) each, Lip Balm is 65 EGP (instead of 100 EGP), and Body Lotion + Splash Bundles are 300 EGP each. We offer premium quality at affordable prices!",
    emoji: "💰",
    animation: "animate-dance",
  },
  {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-10 sm:mt-12 md:mt-16 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4 bg-card/80 backdrop-blur-sm border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 hover:scale-105 hover:shadow-xl hover:shadow-accent/10 transition-all duration-300">
            ...
            <Link href="https://wa.me/201105003495" target="_blank" className="bg-green-500 hover:bg-green-600 text-white px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl font-semibold transition-all inline-flex items-center gap-2 text-sm sm:text-base btn-kawaii">
