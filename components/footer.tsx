...
import { Heart, Instagram, Mail, MessageCircle, Sparkles } from "lucide-react"
      ...
      <div className="container mx-auto px-4 relative">
            ...
            <div className="flex gap-4 justify-center md:justify-end mb-6">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                >
                  <Icon className="w-5 h-5 group-hover:animate-wiggle" />
                </a>
              ))}
            </div>
        ...
        <div className="border-t border-background/10 pt-8 text-center">
          <p className="text-sm text-background/60 flex items-center justify-center gap-2">
            Made with <Heart className="w-4 h-4 text-accent fill-accent animate-heartbeat" /> by
            <span className="font-semibold text-background/80">Luqitchy Cosmetics</span>
          </p>
