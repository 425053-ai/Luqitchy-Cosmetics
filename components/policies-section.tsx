import { CreditCard, ShieldCheck, Sparkles, Heart, Truck } from "lucide-react"
...
const policies = [
  {
    ...
    description:
      "A deposit is required to confirm your order. This ensures we can manage inventory and provide timely delivery.",
  ...
  },
  {
    ...
    title: "Fast Delivery",
    description:
      "Orders are delivered within 24-48 hours across Egypt with safe packaging and careful handling.",
  ...
  },
  {
    ...
    description:
      "We stand behind product quality. If you receive a damaged item, contact us immediately.",
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 sm:gap-3 bg-card/80 backdrop-blur-sm px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full border border-primary/30 mb-5 sm:mb-6 md:mb-8 shadow-lg shadow-primary/10">
          ...
          <h2
            id="policies-heading"
            className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-foreground mb-4 sm:mb-5 md:mb-6 px-2"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 max-w-6xl mx-auto px-2">
          {policies.map((policy) => (
            <Card
              key={policy.title}
              className="relative premium-card border-none rounded-2xl sm:rounded-3xl group overflow-hidden"
            >
              ...
              <div className="relative">
                <CardHeader className="text-center pb-2 sm:pb-3">
                  <div className={`relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-br ${policy.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 md:mb-5 group-hover:scale-110 transition-all shadow-lg`}>
                    ...
                    <span className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 text-sm sm:text-base md:text-lg">{policy.emoji}</span>
                  </div>
                ...
                <CardContent className="text-center px-3 sm:px-4 md:px-6">
                  <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4 md:mb-5 leading-relaxed line-clamp-4">
                    {policy.description}
                  </p>
